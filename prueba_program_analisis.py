            ...
            if input('Enter') == '1':
                ...
                for balanza in objetos_balanzas.values():
                    ...
                    if df_acondicionado is None:
                        # Crear objeto de calculador para calcular las toneladas por día
                        calculador = CalculadorToneladasDia(df_acondicionado)
                        df_dia_graficos.append(0)
                        continue

                    # Crear objeto de calculador para calcular las toneladas por día, y lo guarda en una lista, para luego poder graficarlos
                    calculador = CalculadorToneladasDia(df_acondicionado)
